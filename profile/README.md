...
<div class="section">
    <h1><a href="https://github.com/Daun0808"></a>김다운</h1>

    <div class="section-content">
        <h2>구현한 기능</h2>
        <ul>
            <li><strong>CI/CD</strong> 구축</li>
            <li><strong>포인트</strong> 시스템
                <ul>
                    <li>주문 시 포인트 적립 및 사용</li>
                    <li>포인트 정책 구현</li>
                </ul>
            </li>
            <li><strong>주문 관리</strong>
                <ul>
                    <li>비회원 & 회원 주문 처리</li>
                    <li>주문 내역 조회</li>
                    <li>환불 처리</li>
            ...
            <li><strong>포장지 및 배송</strong>
                <ul>
                    <li>포장지 선택</li>
                    <li>배송 관리</li>
                </ul>
            </li>
            <li><strong>재고 및 결제</strong>
                <ul>
                    <li>재고 처리</li>
                    <li>결제 처리</li>
                    <li>결제 취소</li>
                    <li>결제 상태에 따른 주문 상태 변경</li>
                </ul>
            </li>
        </ul>
...
<div class="section">
    <h1><a href="https://github.com/kihoo-ni"></a>이기훈</h1>

    <div class="section-content">
        <h2>구현한 기능</h2>
        <ul>
            <li><strong>인프라</strong>
                <ul>
                    <li>쿠폰서버 구현 및 CI/CD 적용</li>
                    <li>Springcloud eureka, gateway 서버 구축하여 MSA 기반 환경 구현</li>
                </ul>
            </li>
            <li><strong>쿠폰 관리</strong>
                <ul>
                    <li>쿠폰 정책 생성, 편집, 폐기, 조회 (페이지네이션)</li>
                    <li>정책 생성 시 도서 카테고리 검색</li>
                    <li>쿠폰 템플릿 발급, 조회 (페이지네이션)</li>
                    <li>사용자 쿠폰 발급, 사용됨 처리, 조회 (페이지네이션, 검색)</li>
                    <li>주문 시 쿠폰 선택 기능 (비회원/회원), 쿠폰 계산 처리</li>
                    <li>Spring Scheduler를 사용하여 생일 쿠폰 및 쿠폰 사용됨 처리</li>
                    <li>Querydsl을 사용하여 코드 간결화 및 기존 JPQL 코드 개선</li>
                    <li>N+1 문제 개선</li>
                    <li>Coupon REST API 문서화 (Swagger)</li>
                    <li>RabbitMQ를 이용한 사용자 쿠폰 발급 처리</li>
                </ul>
            </li>
        </ul>
        ...
        <ul class="tech-list">
            ...
            <li>Querydsl</li>
            <li>Springcloud, Eureka, Gateway</li>
        </ul>
    </div>
</div>

<div class="section">
    <h1><a href="https://github.com/dlrudgjs104"></a>이경헌</h1>
    ...
    <div class="section-content">
        ...
        <ul>
            <li><strong>인프라</strong>
                <ul>
                    <li>서버별 Logback, Log & Crash 적용</li>
                    <li>Secure Key Manager</li>
                    <li>Back-end Server 이중화</li>
                </ul>
            </li>
            <li><strong>장바구니</strong>
                <ul>
                    <li>비회원 & 회원 장바구니</li>
                    <li>도서 재고량에 따른 장바구니 추가 구현</li>
                </ul>
            </li>
            <li><strong>도서 관리</strong>
                <ul>
                    <li>도서 카테고리별 검색 및 정렬</li>
                    <li>도서, 카테고리, 태그, 출판사, 저자 관리</li>
                    <li>도서 위시리스트</li>
                </ul>
            </li>
            <li><strong>리뷰 관리</strong>
                <ul>
                    <li>리뷰 사진 업로드</li>
                    <li>리뷰 포인트 적립</li>
                    <li>리뷰 조회 (도서별, 회원별, 리뷰 유형별)</li>
                    <li>도서별 리뷰 평점 및 리뷰 개수 조회</li>
                    <li>주문한 도서 중 배송 완료된 도서에 대해서만 리뷰 작성</li>
                </ul>
            </li>
            <li><strong>배송</strong>
                <ul>
...
<div class="section">
    <h1><a href="https://github.com/2897robo"></a>김기욱</h1>
    ...
    <div class="section-content">
        ...
        <ul>
            <li><strong>인프라</strong>
                <ul>
                    <li>Elastic Search, NHN Cloud 인스턴스 초기 설정</li>
                </ul>
            </li>
            <li><strong>도서</strong>
                <ul>
                    <li>외부 API (네이버, 알라딘) 활용하여 도서 정보 가져오기 및 매핑</li>
                    <li>NHN Cloud Image Manager 이미지 API를 사용하여 이미지 가져오기 및 업로드</li>
                </ul>
            </li>
            <li><strong>검색 기능</strong>
                <ul>
                    <li>LogStash, Kibana, Elastic 초기 설정</li>
                    <li>저자, 도서, 태그, 출판사 기준으로 검색 기능 구현</li>
                </ul>
            </li>
        </ul>
        ...
        <ul class="tech-list">
            ...
            <li>Kibana</li>
            <li>NHN Cloud</li>
            <li>외부 API (네이버, 알라딘)</li>
            <li>NHN Cloud Image Manager</li>
        </ul>
    </div>
</div>
